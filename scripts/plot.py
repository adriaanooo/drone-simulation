...
sns.lineplot(x=df['Time (s)'], y=df['Roll Angle (deg)'], label='Roll Angle (deg)', ax=axes[1, 0])
sns.lineplot(x=df['Time (s)'], y=df['Roll Rate (deg/s)'], label='Roll Velocity (deg/s)', ax=axes[0, 0], color='b')
sns.lineplot(x=df['Time (s)'], y=df['Pitch Angle (deg)'], label='Pitch Angle (deg)', ax=axes[1, 0])
sns.lineplot(x=df['Time (s)'], y=df['Pitch Rate (deg/s)'], label='Pitch Velocity (deg/s)', ax=axes[0, 0], color='r')
sns.lineplot(x=df['Time (s)'], y=df['Yaw Angle (deg)'], label='Yaw Angle (deg)', ax=axes[1, 0])
